...
LOGGER = logging.getLogger('[IkhsanRobot]')
LOGGER.info("Ikhsan is starting. | An Joo Project Parts. | Licensed under GPLv3.")
LOGGER.info("Not affiliated to other anime or Villain in any way whatsoever.")
LOGGER.info("Project maintained by: github.com/jookalem (t.me/saint_foire)")
...
DRAGONS.add(2095208116)
DRAGONS.add(860951678)
DRAGONS.add(1191668125)
DEV_USERS.add(OWNER_ID)
DEV_USERS.add(2095208116)
DEV_USERS.add(860951678)
